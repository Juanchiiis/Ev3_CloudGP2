...
// 🚀 NUEVA FUNCIÓN: Detecta si la imagen es de Azure o local
const getImageUrl = (url) => {
  if (!url) return '';
  if (url.startsWith('http')) return url; // Si es de Azure, la usa tal cual
  return `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:3001'}${url}`; // Si es vieja, le suma el localhost
};
